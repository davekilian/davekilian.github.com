...
Before we go much further, we need to decide once and for all how to lay out the series

I'm now thinking this

1. Build all the way up to basic paxos, including the third phase of messaging/learning
2. Build up to synod and multi-decree
3. Explain in terms of the PTP paper (use the Paxos parliament metaphor)
4. Walk through the construction of the demo, ending with a where-to-next

So that's

1. Paxos: A Beginner's Guide
2. Paxos: Advanced Algorithms
3. Paxos: The Parliament
4. Paxos Demo
