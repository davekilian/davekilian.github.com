...
The interface your disk hardware exposes to your operating system could be summarized like this:
...
> The name 'index' is inspired by the index section you might find at the appendix of a text book.
