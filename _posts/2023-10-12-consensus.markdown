...
All looks well so far. Now, let's try the case that broke our algorithm before. Say the leader crashes or gets disconnected (jeez Ted); now node 1 is offline:
