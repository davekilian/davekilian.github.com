...
In the bad old days, any serious education in distributed systems involved learning the Paxos consensus algorithm, and that was a bad thing because Paxos was (and still is) notoriously difficult to understand. Even the experts didn’t understand the Paxos paper when it was first published (and because so few people understood the paper right away, Paxos in general ended up [languishing in obscurity for the better part of a decade](https://www.microsoft.com/en-us/research/publication/part-time-parliament/)). Needless to say, if the experts can’t make heads or tails of Paxos, students are really going to struggle. But for a time, Paxos was the only known solution to consensus, and consensus is an important problem, so subjecting students to Paxos was a cruel necessity.
