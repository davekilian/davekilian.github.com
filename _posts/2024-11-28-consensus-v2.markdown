...
I would venture to say programmers generally know two things about consensus algorithms: that they're important for cloud computing at a fundamental level, and that basically nobody knows how they work &mdash; in fact, most people can't really say what a consensus algorithm does, or what fundamental role consensus would play in a larger system. You can work on cloud software all your life and never interact with a consensus algorithm even once, and at the same time you cannot escape from relying on consensus either, because consensus algorithms are running somewhere behind all the APIs and abstractions your cloud software is built on. This article itself was brought to you in part by a consensus algorithm, when you opened this page.
