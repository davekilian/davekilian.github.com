...
Nowadays there is a second consensus algorithm, *Raft*, which accomplishes the same basic things as Paxos while being much eaier to understand. Should one subject themselves to Paxos now that Raft exists?
