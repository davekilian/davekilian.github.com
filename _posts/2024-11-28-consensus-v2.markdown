...
I would venture to say programmers generally know two things about distributed consensus algorithms: they play a fundamental role in distributed systems like the cloud, and nobody understands them &mdash; in fact, nobody can really even tell you what they do, or what makes them important in the first place. You can work on cloud software all your life and never interact with a consensus algorithm even once. But you also cannot escape from consensus, because there are consensus algorithms running behind all the APIs and abstractions your favorite cloud software is built on. This article itself was brought to you in part by a consensus algorithm, when you opened this page.

I've always found it strange that consensus algorithms can be so important, yet so obscure. The solution to the paradox, I think, is that there probably aren't all that many implementations of consensus running out there in the wild &mdash; but the ones that do exist touch almost everything you do online, in a small and indirect, yet indispensable way. That consensus remains obscure is maybe an artifact of modern computing being so centralized on a small number of providers; decentralizing would probably require more people to understand consensus more deeply.
